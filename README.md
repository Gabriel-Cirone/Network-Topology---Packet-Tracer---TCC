...
Features: Remote monitoring Wireless network communication Smartphone control (unfortunately, packet tracer doesn't support such IoT implementation, I just put the IP to the Smartphone, and to Cell Tower)
